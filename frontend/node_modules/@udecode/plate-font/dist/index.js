...
const createFontBackgroundColorPlugin = plateCore.createPluginFactory({
  key: MARK_BG_COLOR,
  inject: {
    props: {
...
const createFontColorPlugin = plateCore.createPluginFactory({
  key: MARK_COLOR,
  inject: {
    props: {
      nodeKey: MARK_COLOR,
...
const createFontFamilyPlugin = plateCore.createPluginFactory({
...
const createFontSizePlugin = plateCore.createPluginFactory({
  key: MARK_FONT_SIZE,
  inject: {
    props: {
...
const createFontWeightPlugin = plateCore.createPluginFactory({
