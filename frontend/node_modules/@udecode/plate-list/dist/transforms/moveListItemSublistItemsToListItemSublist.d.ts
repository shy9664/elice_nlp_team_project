 ...
 */
export declare const moveListItemSublistItemsToListItemSublist: (editor: PlateEditor, { fromListItem, toListItem, start, }: MoveListItemSublistItemsToListItemSublistOptions) => number;
