...
const getPopoverStyles = props => plateStyledComponents.createStyles({
  prefixClassNames: 'Popover',
  ...props
}, {
  root: [{
    "display": "flex",
    ...
    "outlineOffset": "2px"
  }, Ce(["border-radius:3px;max-width:350px;font-size:14px;box-shadow:rgba(9,30,66,0.31) 0 0 1px,rgba(9,30,66,0.25) 0 4px 8px -2px;"])]
});
...
const Popover = ({
  ...
  const tippyProps = {
    ...
    render: attrs => {
      const {
        root
      } = getPopoverStyles(props);
      return /*#__PURE__*/r__default['default'].createElement(_StyledDiv, _extends({}, attrs, {
  ...
  return /*#__PURE__*/r__default['default'].createElement(Tippy__default['default'], _extends({}, tippyProps, props));
};

var _StyledDiv = He("div").withConfig({
  displayName: "Popover___StyledDiv",
  componentId: "sc-q0u1f-0"
})(["", ""], p => p.$_css);

exports.Popover = Popover;
exports.getPopoverStyles = getPopoverStyles;
