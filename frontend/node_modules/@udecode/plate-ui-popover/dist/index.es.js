...
const getPopoverStyles = props => createStyles({
...
const Popover = ({
  ...
  const tippyProps = {
    ...
    render: attrs => {
      ...
      return /*#__PURE__*/r.createElement(_StyledDiv, _extends({}, attrs, {
  ...
  return /*#__PURE__*/r.createElement(Tippy, _extends({}, tippyProps, props));
};
...
export { Popover, getPopoverStyles };
