...
const devtools = (fn, options) => (set, get, api) => {
  ...
  const extensionConnector = (_a = window.__REDUX_DEVTOOLS_EXTENSION__) != null ? _a : window.top.__REDUX_DEVTOOLS_EXTENSION__;
  ...
  api.setState = (state, replace, nameOrAction) => {
    ...
    if (!isRecording)
      return;
    extension.send(nameOrAction === void 0 ? { type: (_a2 = devtoolsOptions.anonymousActionType) != null ? _a2 : "anonymous" } : typeof nameOrAction === "string" ? { type: nameOrAction } : nameOrAction, get());
  };
