...
var devtools = function devtools(fn, options) {
  return function (set, get, api) {
    ...
    var extensionConnector = (_REDUX_DEVTOOLS_EXTE = window.__REDUX_DEVTOOLS_EXTENSION__) != null ? _REDUX_DEVTOOLS_EXTE : window.top.__REDUX_DEVTOOLS_EXTENSION__;
    ...
    api.setState = function (state, replace, nameOrAction) {
      var _devtoolsOptions$anon;

      set(state, replace);
      if (!isRecording) return;
      extension.send(nameOrAction === undefined ? {
        type: (_devtoolsOptions$anon = devtoolsOptions.anonymousActionType) != null ? _devtoolsOptions$anon : 'anonymous'
