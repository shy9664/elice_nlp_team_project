 ...
 */
export declare const pluginInjectProps: (editor: PlateEditor, { key, inject: { props } }: WithPlatePlugin, nodeProps: GetInjectPropsOptions) => GetInjectPropsReturnType | undefined;
