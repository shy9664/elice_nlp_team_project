...
export declare type PlatePluginInsertDataOptions = {
    data: string;
    dataTransfer: DataTransfer;
};
export declare type PlatePluginInsertData = {
    /**
     ...
     */
    preInsert?: (fragment: TDescendant[], options: PlatePluginInsertDataOptions) => HandlerReturnType;
    /**
     ...
     */
    transformFragment?: (fragment: TDescendant[], options: PlatePluginInsertDataOptions) => TDescendant[];
};
