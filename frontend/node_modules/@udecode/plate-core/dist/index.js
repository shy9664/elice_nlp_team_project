...
const usePlateKey = (key, id) => usePlateStore(React.useCallback(() => {
  var _getPlateState;
...
const useEditableProps = ({
  ...
  return React.useMemo(() => ({ ...omit_1(editableProps, [...DOM_HANDLERS, 'renderElement', 'renderLeaf']),
    ...props
  }), [editableProps, props]);
};
  ...
  return React.useMemo(() => {
    ...
    return {
      ...
      resetEditor: (id = stateId) => {
        ...
        setEditor(withPlate(slate.createEditor(), {
          id,
...
const usePlateEffects = ({
  ...
  const editor = usePlateEditorRef(id);
  const prevEditorRef = React.useRef(editor); // Clear the state on unmount.
  ...
  React.useEffect(() => {
    if (!editor && enabled) {
      const baseEditor = editorProp !== null && editorProp !== void 0 ? editorProp : slate.createEditor();
...
exports.usePlateKey = usePlateKey;
