...
})(self, function(__WEBPACK_EXTERNAL_MODULE__227__) {
...
function colorSyntaxPlugin(context, options) {
    ...
    eventEmitter.listen('focus', function (editType) {
        var containerClassName = "" + PREFIX + (editType === 'markdown' ? 'md' : 'ww') + "-container";
        currentEditorEl = document.querySelector("." + containerClassName + " .ProseMirror");
    });
